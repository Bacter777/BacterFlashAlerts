...
import com.bacter.bacterflashalerts.ahuk.materialdatetimepicker.time.TimePickerDialog;
import com.bacter.bacterflashalerts.bacter.flashalert.service.FlashServices;
import com.bacter.bacterflashalerts.bacter.flashalert.service.ServiceCheckBattery;
import com.bacter.bacterflashalerts.bacter.flashalert.service.ServiceStartFlash;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener,
    ...
    private void initView() {
        mTvHourMinuteStart = findViewById(R.id.tv_hour_minute_start);
        mTvHourMinuteEnd = findViewById(R.id.tv_hour_minute_end);
        mSwFlashAlerts = findViewById(R.id.sw_flash_alerts);
        mSwIncomingCall = findViewById(R.id.sw_incoming_call);
        mSwIncomingSms = findViewById(R.id.sw_incoming_sms);
        mSwEnableFlashAlert = findViewById(R.id.sw_enable_flash);
        mSwNormalMode = findViewById(R.id.sw_normal_mode);
        mSwVibrateMode = findViewById(R.id.sw_vibrate_mode);
        mSwSilentMode = findViewById(R.id.sw_silent_mode);
        mSwDisableWhenBattery = findViewById(R.id.sw_disable_when_battery_below);
        mSwDoNotDisturb = findViewById(R.id.sw_do_not_disturb);
        mSwDndStart = findViewById(R.id.sw_dnd_start);
        mSwDndEnd = findViewById(R.id.sw_dnd_end);
        mSbOnLength = findViewById(R.id.sb_onlength);
        mSbOffLength = findViewById(R.id.sb_off_length);
        mSbBlinkTime = findViewById(R.id.sb_blink_time);
        mBtnTestStart = findViewById(R.id.btn_test_start);
        mBtnTestStop = findViewById(R.id.btn_test_stop);
        mTvOnLength = findViewById(R.id.tv_on_length);
        mTvOffLength = findViewById(R.id.tv_off_length);
        mTvBlinkTime = findViewById(R.id.tv_blink_time);
...
//                        }
    ...
    public void onBackPressed(){
        CustomAlertDialogue.Builder ahukBuilder = new CustomAlertDialogue.Builder(MainActivity.this)
                .setStyle(CustomAlertDialogue.Style.DIALOGUE)
                .setCancelable(false)
                .setTitle("Bacter Flash Alerts")
